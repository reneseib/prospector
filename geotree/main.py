...
rustf.start(PRIMARY_DATA)

#
# # Load data to typed dict
# # PRIMARY_DATA = load_geometries_typed_dict(primary_src_data)
#
...
#
# # SECONDARY_DATA = load_geometries_typed_dict(secondary_src_data)
#
# t1 = timeit.default_timer() - t0
...
# SD_centroids = batch_centroids(SECONDARY_DATA)
#
...
#         closest_sd_ids = [x[0] for x in nth_sorted_id_distances]
#
#         rd_polygon_ids_on_this_leaf = TREE["primary"]["collections"][leaf_to_load]
#
#         t0 = timeit.default_timer()
#         shortest_distance = rustf.calculate_shortest_distance(
